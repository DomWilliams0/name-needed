...
pub struct TaskReservations {
    entity_to_task: HashMap<Entity, SocietyTask>,
    task_to_entity: HashMap<SocietyTask, Entity>,
}
...
impl TaskReservations {
    pub fn reserve(
        ...
        entity: Entity,
        task: SocietyTask,
    ) -> (Option<SocietyTask>, Option<Entity>) {
    ...
    pub fn unreserve(&mut self, entity: Entity) -> Option<SocietyTask> {
    ...
    pub fn is_available_to(&self, task: &SocietyTask, entity: Entity) -> bool {
