...
pub const __GLIBCXX__: u32 = 20190812;
...
extern "C" {
    pub fn dynworld_create(gravity: f32) -> *mut dynworld;
}
extern "C" {
    pub fn dynworld_destroy(world: *mut dynworld);
}
extern "C" {
...
>;
extern "C" {
    pub fn dynworld_set_debug_drawer(world: *mut dynworld, draw_line: fn_draw_line);
}
extern "C" {
    #[doc = " frame_blob will be passed back to rust draw_* functions as first argument"]
    pub fn dynworld_debug_draw(world: *mut dynworld, frame_blob: *mut ::std::os::raw::c_void);
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct slab_collider {
    _unused: [u8; 0],
}
extern "C" {
    #[doc = " if prev is not null, it is deleted from the world and freed first"]
    pub fn slab_collider_update(
        world: *mut dynworld,
        prev: *mut slab_collider,
        slab_pos: *const f32,
        vertices: *const f32,
