...
* [X] when evaluating a break/build thing in a range, dont always do all blocks in the same order
* [X] add check for enough hands before considering finding food to pickup
